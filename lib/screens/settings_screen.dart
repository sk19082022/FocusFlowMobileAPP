...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  static const String _portfolioLink = 'https://santhoshkumar.dev'; // Change to your portfolio link
                        ...
                        _buildSection(
                          ...
                          children: [
                            Card(
                              ...
                              child: InkWell(
                                borderRadius: BorderRadius.circular(12),
                                onTap: () => _launchUrl(_developerLink),
                                child: Padding(
                                  padding: const EdgeInsets.all(16),
                                  child: Row(
                                    children: [
                        ...
                        _buildSection(
                          ...
                          children: [
                            ListTile(
                              ...
                              subtitle: const Text('github.com/sk19082022'),
                            ...
                            ListTile(
                              ...
                              trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                              onTap: () => _launchUrl(_portfolioLink),
                            ),
                          ],
                        ),
